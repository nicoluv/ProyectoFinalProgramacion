...
public class Campista extends Bateador {
	
	private static final long serialVersionUID = 1L;
	private Estadistica estad;
	
	public Campista(String nombre, Date fechaNacimiento, int peso, int altura, String lanzamiento, String bateo, String paisOrigen,
